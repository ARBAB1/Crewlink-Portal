...
fetchPost();
  ...
  yaxis: {
    ...
    min: 0,
    max: (Math.ceil(((Math.max(...postChartData))+(Math.max(...postChartData)*0.1))/10))*10,
  },
};
        ...
        <div className="flex w-full flex-wrap gap-3 sm:gap-5">
          <div className="flex min-w-47.5">
            ...
            <div className="w-full">
              <p className="font-semibold text-primary">Total Posts</p>
              <p className="text-sm font-medium">{postChartData.reduce((accumulator, currentValue) => accumulator + currentValue, 0)}</p>
            </div>
          </div>
